...
class OnFullscreenImageClickListener(val context: Context, private val photoUri: String?) : View.OnClickListener {
    override fun onClick(v: View?) {
        val nagDialog = Dialog(context, R.style.Theme_Translucent_NoTitleBar_Fullscreen).apply {
            requestWindowFeature(Window.FEATURE_NO_TITLE)
            setCancelable(false)
            setContentView(com.coolapps.goonerpi.notes.R.layout.fullsize_image)
        }
        ...
        nagDialog.setOnKeyListener { dialog, keyCode, _ ->
